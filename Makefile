...
SRCS	=	$(PATH_SRC)/check_args.c \
		...
		$(PATH_SRC)/scripting/diff_cond_script.c \
		$(PATH_SRC)/scripting/equal_cond_script.c \
		$(PATH_SRC)/scripting/inf_cond_script.c \
		$(PATH_SRC)/scripting/inf_eq_cond_script.c \
		$(PATH_SRC)/scripting/sup_cond_script.c \
		$(PATH_SRC)/scripting/sup_eq_cond_script.c \
